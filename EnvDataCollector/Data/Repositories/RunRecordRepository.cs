            ...
            return db.QuerySingle<long>(@"
                INSERT INTO run_record
                    (device_id, device_type, device_code, start_time, end_time,
                     ...
                     currents_max, currents_min, currents_avg, currents_median,
                     water_pressure_max, water_pressure_min, water_pressure_avg, water_pressure_median,
                     flow_quantity_max, flow_quantity_min, flow_quantity_avg, flow_quantity_median,
                     vehicle_no,
                ...
                VALUES
                    (@DeviceId, @DeviceType, @DeviceCode, @StartTime, @EndTime,
                     ...
                     @CurrentsMax, @CurrentsMin, @CurrentsAvg, @CurrentsMedian,
                     @WaterPressureMax, @WaterPressureMin, @WaterPressureAvg, @WaterPressureMedian,
                     @FlowQuantityMax, @FlowQuantityMin, @FlowQuantityAvg, @FlowQuantityMedian,
                     @VehicleNo,
